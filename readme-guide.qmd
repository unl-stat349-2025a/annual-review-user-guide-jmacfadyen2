...
# Making a README File {.unnumbered}

## README Files

A README file is a crucial document in data sharing, as it provides
essential, easy-to-read information about a project, dataset, or collection of files.
It serves as both a guide and documentation to help users understand the
purpose, structure, and usage of the file it describes. Even if some
...
to speed up the process, such as [this one](https://cornell.app.box.com/v/ReadmeTemplate) (@cornelluniversitya), but it's important they include what's covered
...
This README file guide was adapted from the following sources:

- Cornell University - @cornelluniversity
- Harvard University - @harvarduniversity
- The Open University - @chadwick